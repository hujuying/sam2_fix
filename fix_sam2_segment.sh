...
# ==============================================================================
# 脚本：fix_sam2_segment.sh
# 功能：替换指定路径下的 AILab_SAM2Segment.py 文件，并在替换前创建备份。
# 设计为独立脚本，接受目标路径作为参数。
# ==============================================================================
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "示例:"
    echo "  $0 /workspace/ComfyUI/custom_nodes/comfyui-rmbg/AILab_SAM2Segment.py"
    echo ""
    echo "此脚本会尝试将 '/workspace/temp/AILab_SAM2Segment.py.fix' 复制到指定的目标路径。"
